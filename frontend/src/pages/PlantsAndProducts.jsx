            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
                {plants.map((plant) => (
                    <Card key={plant._id} className="h-full">
                        ...
                        <div className='p-4'>
                            ...
                            <h3 className="text-xl font-semibold hover:text-[1.3rem] hover:text-black tracking-tight text-gray-600 dark:text-white">
                                {plant.name}
                            </h3>
                            </Link>
                            <h4 className="text-black font-bold dark:text-white cursor-default">{plant.price} €</h4>
                ...
                {products.map((product) => (
                    ...
                    <div className='p-4'>
                        ...
                        <h4 className="text-black font-bold dark:text-white cursor-default">{product.price} €</h4>
                        <Button size='md' className='m-auto bg-myGreen hover:!bg-myLightGreen mt-2'>
                        Aggiungi al carrello
                        </Button>
                    </div>
