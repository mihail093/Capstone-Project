...
export default function UserDashboard({ favorites }) {
    ...
    >
        <div>
            ...
            <div className='rounded-full text-xl text-myBeige p-2 mt-6'>
                <div className='rounded-full mb-2 py-2 px-2 bg-black cursor-pointer hover:bg-myLightBeige hover:text-black' onClick={() => {setIsModalOpen(true)}}>Preferiti</div>
                <div className='rounded-full mb-2 py-2 px-2 bg-black cursor-pointer hover:bg-myLightBeige hover:text-black'>Ultimi Acquisti</div>
                <div className='rounded-full mb-2 py-2 px-2 bg-black cursor-pointer hover:bg-myLightBeige hover:text-black'>Cronologia Acquisti</div>
                <div className='rounded-full mb-2 py-2 px-2 bg-black cursor-pointer hover:bg-myLightBeige hover:text-black'>Commenti e Recensioni</div>
